...
namespace ET
{
  ...
  void loadHeightmapFromImage(TerrainInfo& info, const Ogre::Image& image);
  ...
  void saveHeightmapToImage(const TerrainInfo& info, Ogre::Image& image, unsigned int bpp = 2);
  ...
  void loadHeightmapFromRawData(TerrainInfo& info, Ogre::DataStream& stream,
    size_t width, size_t height);
  ...
  void saveHeightmapToRawData(const TerrainInfo& info, std::ostream& stream, unsigned int bpp = 2);
  ...
  void createTerrainLightmap(const TerrainInfo& info, Ogre::Image& image,
    size_t width, size_t height, Ogre::Vector3 lightDir, const Ogre::ColourValue& lightCol,
    const Ogre::ColourValue& ambient, bool shadowed = true);
