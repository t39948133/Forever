...
long long CPacketPlayerInit::getUID()
{
   return m_uid;
}

void CPacketPlayerInit::pack(CPlayer *pPlayer)
{
...
void CPacketPlayerInit::unpack(CPlayer *pPlayer)
{
...
void CPacketPlayerInit::unpack(CPlayer3D *pPlayer3D)
{
